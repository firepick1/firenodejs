...
(function(exports) {
    ...
    RestSync.prototype.syncBegin = function(reqBody) {
        var that = this;
        return reqBody && reqBody.sync && that.synchronizer.sync(reqBody.sync);
    }
    RestSync.prototype.syncEnd = function(syncResponse, resultPromise) {
